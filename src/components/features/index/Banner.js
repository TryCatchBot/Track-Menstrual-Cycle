...
const Banner = ({onTrackPeriodClick}) => {
    ...
    <>
      <Container maxW={'3xl'}>
        <Stack
          ...
          py={{ base: 20, md: 36 }} mt={20}>
          <Heading
            fontWeight={600}
            fontSize={{ base: '2xl', sm: '4xl', md: '6xl' }}
            lineHeight={'110%'} mt={-24}>
            Track Your Menstrual<br />
            <Text as={'span'} color={'#DA70D6'}>
            Cycle and Ovulation 
            </Text>
          </Heading>
          ...
          <Stack
            ...
            <Box>
              ...
              <Text
                ...
                right={'-125px'}
                top={'-15px'}
                transform={'rotate(10deg)'} as='i' color='teal'>
                Free forever
              </Text>
            </Box>
          </Stack>
